...
namespace exemplo.Controllers
{
    ...
    public class FuncionariosController : ApiController
    {
        ...
        public HttpResponseMessage Salvar(String Usu_adm, String Usuario, String Senha, String Descricao, String Comissao, string fk_empresa)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(this.ConnectionString))
                {
                    ...
                    {
                        command.Connection = connection;
                        command.CommandText = " insert into funcionarios values (" + Usu_adm + ",'" + Usuario + "','" + Senha + "','" + Descricao + "'," + Comissao + ", " + fk_empresa + ") ";
        ...
        public HttpResponseMessage Alterar(String Id, String Usu_adm, String Usuario, String Senha, String Descricao, String Comissao, string fk_empresa)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(this.ConnectionString))
                {
                    ...
                    {
                        command.Connection = connection;
                        command.CommandText = " update funcionarios set usu_adm = " + Usu_adm + ", usuario = '" + Usuario + "', senha = '" + Senha + "', descricao = '" + Descricao + "', comissao = " + Comissao + "  where id = " + Id + " and fk_empresa = " + fk_empresa;
