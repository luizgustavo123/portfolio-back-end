...
namespace exemplo.Controllers
{
    ...
    public class ProdutosController : ApiController
    {
        ...
        public HttpResponseMessage Produtos_filtro(String Id, String Nome, string fk_empresa, string filtrar_vencidos)
        {
            try
            {
                List<produtos> lstprodutos = new List<produtos>();
        ...
        public HttpResponseMessage Produtos_catalogo(string primeiro_acesso)
        {
            try
            {
                List<produtos> lstprodutos = new List<produtos>();
                ...
                using (SqlConnection connection = new SqlConnection(this.ConnectionString))
                {
                    ...
                    using (SqlCommand command = new SqlCommand())
                    {
                        ...
                        {
                            command.CommandText = "select top 21 fk_categoria, tipo, imagem_link, id, produto, FORMAT(custo, 'C', 'pt-br') AS 'custo', FORMAT(valor_pessoa_fisica, 'C', 'pt-br') AS 'valor_pessoa_fisica', FORMAT(valor_pessoa_juridica, 'C', 'pt-br') AS 'valor_pessoa_juridica', qtd, estoque_minimo from produtos where (valor_pessoa_fisica <> 0 or valor_pessoa_juridica <> 0) and (qtd > 0) and produto not like '%PAULISTINHA%' ORDER BY produto";
                        }
                        else
                        {
                            command.CommandText = "select tipo, fk_categoria, imagem_link, id, produto, FORMAT(custo, 'C', 'pt-br') AS 'custo', FORMAT(valor_pessoa_fisica, 'C', 'pt-br') AS 'valor_pessoa_fisica', FORMAT(valor_pessoa_juridica, 'C', 'pt-br') AS 'valor_pessoa_juridica', qtd, estoque_minimo from produtos where (valor_pessoa_fisica <> 0 or valor_pessoa_juridica <> 0) and (qtd > 0) and produto not like '%PAULISTINHA%' ORDER BY produto";
                        }
                        SqlDataReader reader = command.ExecuteReader();
        ...
        public HttpResponseMessage produtos_catalogo_categoria(string primeiro_acesso, string categoria)
        {
            try
            {
                List<produtos> lstprodutos = new List<produtos>();
                ...
                using (SqlConnection connection = new SqlConnection(this.ConnectionString))
                {
                    ...
                    using (SqlCommand command = new SqlCommand())
                    {
                        ...
                        if (primeiro_acesso == "true")
                        {
                            command.CommandText = "select top 21 fk_categoria, tipo, imagem_link, id, produto, FORMAT(custo, 'C', 'pt-br') AS 'custo', FORMAT(valor_pessoa_fisica, 'C', 'pt-br') AS 'valor_pessoa_fisica', FORMAT(valor_pessoa_juridica, 'C', 'pt-br') AS 'valor_pessoa_juridica', qtd, estoque_minimo from produtos where (valor_pessoa_fisica <> 0 or valor_pessoa_juridica <> 0) and (qtd > 0) and produto not like '%PAULISTINHA%' and fk_categoria = " + categoria + " ORDER BY produto";
                        }
                        else
                        {
                            command.CommandText = "select tipo, fk_categoria, imagem_link, id, produto, FORMAT(custo, 'C', 'pt-br') AS 'custo', FORMAT(valor_pessoa_fisica, 'C', 'pt-br') AS 'valor_pessoa_fisica', FORMAT(valor_pessoa_juridica, 'C', 'pt-br') AS 'valor_pessoa_juridica', qtd, estoque_minimo from produtos where (valor_pessoa_fisica <> 0 or valor_pessoa_juridica <> 0) and (qtd > 0) and produto not like '%PAULISTINHA%' and fk_categoria = " + categoria + " ORDER BY produto";
        ...
        public HttpResponseMessage Produtos_nome(string Nome, int Check_estoque_minimo)
        {
            try
            {
                List<produtos> lstprodutos = new List<produtos>();
                ...
                using (SqlConnection connection = new SqlConnection(this.ConnectionString))
                {
                    ...
                    using (SqlCommand command = new SqlCommand())
                    {
                        ...
                        {
                            command.CommandText = "select fk_categoria, categoria, data_validade, tipo, imagem_link, id, produto, FORMAT(custo, 'C', 'pt-br') AS 'custo', FORMAT(valor_pessoa_fisica, 'C', 'pt-br') AS 'valor_pessoa_fisica', FORMAT(valor_pessoa_juridica, 'C', 'pt-br') AS 'valor_pessoa_juridica', qtd, estoque_minimo from produtos where produto like '%" + Nome + "%' and (qtd < estoque_minimo or qtd = 0 ) and produto not like '%PAULISTINHA%' ORDER BY produto ";
                        }
                        if (Check_estoque_minimo == 2)
                        {
                            command.CommandText = "select fk_categoria, categoria, data_validade, tipo, imagem_link, id, produto, FORMAT(custo, 'C', 'pt-br') AS 'custo', FORMAT(valor_pessoa_fisica, 'C', 'pt-br') AS 'valor_pessoa_fisica', FORMAT(valor_pessoa_juridica, 'C', 'pt-br') AS 'valor_pessoa_juridica', qtd, estoque_minimo from produtos where produto like '%" + Nome + "%' and (qtd > 0) and produto not like '%PAULISTINHA%' ORDER BY produto ";
                        }
                        else
                        {
                            command.CommandText = "select fk_categoria, categoria, data_validade, tipo, imagem_link, id, produto, FORMAT(custo, 'C', 'pt-br') AS 'custo', FORMAT(valor_pessoa_fisica, 'C', 'pt-br') AS 'valor_pessoa_fisica', FORMAT(valor_pessoa_juridica, 'C', 'pt-br') AS 'valor_pessoa_juridica', qtd, estoque_minimo from produtos where produto like '%" + Nome + "%' and produto not like '%PAULISTINHA%' ORDER BY produto ";
                        }
        ...
        public HttpResponseMessage Salvar(string fk_empresa, string Imagem_link, string Categoria, string Id, string Produto, string Custo,
            string Valor_pessoa_fisica, string Valor_pessoa_juridica, string Qtd, string Estoque_minimo, string Tipo, string Descricao, string data_validade)
        {
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(this.ConnectionString))
                {
                    ...
                    using (SqlCommand command = new SqlCommand())
                    {
                        ...
                        command.Connection = connection;
                        command.CommandText = "insert into produtos (data_validade, fk_empresa, fk_categoria, imagem_link, id, produto, custo, valor_pessoa_fisica, valor_pessoa_juridica, qtd, estoque_minimo,descricao, tipo )values(" + data_validade + "," + fk_empresa + "," + Categoria + ", '" + Imagem_link + "'," + Id + ", '" + Produto + "', " + Custo + ", " + Valor_pessoa_fisica + ", " + Valor_pessoa_juridica + "," + Qtd + ", " + Estoque_minimo + ",'" + Descricao + "','" + Tipo + "')";
                        SqlDataReader reader = command.ExecuteReader();
        ...
        public HttpResponseMessage Alterar(string Id_novo, string Imagem_link, string Categoria, string Id, string Produto, string Custo, string Valor_pessoa_fisica, string Valor_pessoa_juridica, string Qtd, string Estoque_minimo, string Tipo, string Descricao, string fk_empresa, string data_validade)
        {
            try
            {
                List<Pedidos> lstPedidos = new List<Pedidos>();
                ...
                using (SqlConnection connection = new SqlConnection(this.ConnectionString))
                {
                    ...
                    using (SqlCommand command = new SqlCommand())
                    {
                        ...
                        command.Connection = connection;
                        command.CommandText = "update produtos set data_validade = " + data_validade + ", id = " + Id_novo + ", fk_categoria = " + Categoria + ", imagem_link = '" + Imagem_link + "', produto = '" + Produto + "', custo = " + Custo + ", valor_pessoa_fisica = " + Valor_pessoa_fisica + ", valor_pessoa_juridica = " + Valor_pessoa_juridica + ", qtd = " + Qtd + ", estoque_minimo = " + Estoque_minimo + ", tipo = '" + Tipo + "', descricao = '" + Descricao + "' where id = " + Id + " and fk_empresa = " + fk_empresa;
